...
function optionsframework_options(){
    ...
    $options[] = array(
        'name'=>'站点图标',
        'id'=>'site_ico',
        'std'=>'https://cdn.jsdelivr.net/gh/showrbq/kratos-alpha@'.KRATOS_VERSION.'/images/favicon.ico',
        'type'=>'upload');
    $options[] = array(
    ...
    $options[] = array(
        ...
        'std'=>'https://cdn.jsdelivr.net/gh/showrbq/kratos-alpha@'.KRATOS_VERSION.'/images/index_image.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'主页布局',
    ...
    $options[] = array(
        ...
        'id'=>'fa_url',
        'std'=>'https://cdn.jsdelivr.net/gh/showrbq/kratos-alpha@'.KRATOS_VERSION.'/css/font-awesome.min.css',
        'type'=>'text');
    $options[] = array(
        'name'=>'自定义Bootstrap(JS)',
        'desc'=>'自定义Bootstrap链接，留空将从本地加载',
        'id'=>'bs_url',
        'std'=>'https://cdn.jsdelivr.net/gh/showrbq/kratos-alpha@'.KRATOS_VERSION.'/js/bootstrap.min.js',
        'type'=>'text');
    $options[] = array(
        'name'=>'自定义jQuery',
        'desc'=>'自定义jQuery链接，留空将从本地加载',
        'id'=>'jq_url',
        'std'=>'https://cdn.jsdelivr.net/gh/showrbq/kratos-alpha@'.KRATOS_VERSION.'/js/jquery.min.js',
        'type'=>'text');
    $options[] = array(
        'name'=>'其它JS与CSS',
    ...
    $options[] = array(
        'name'=>'歌单JSON地址',
        'desc'=>'借助API可解析网易云歌单，如https://api.fczbl.vip/163/?type=playlist&id=2003373695',
        'id'=>'ap_json',
    ...
    $options[] = array(
        ...
        'id'=>'weixin_image',
        'std'=>'https://cdn.jsdelivr.net/gh/showrbq/kratos-alpha@'.KRATOS_VERSION.'/images/weixin.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'打赏页面标题',
        'id'=>'paytext_head',
    ...
    $options[] = array(
        ...
        'id'=>'wechatpayqr_url',
        'std'=>'https://cdn.jsdelivr.net/gh/showrbq/kratos-alpha@'.KRATOS_VERSION.'/images/wechatpayqr.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'支付婊收款码',
        'desc'=>'上传你的支付婊收款二维码图片，图片尺寸要大于200px',
        'id'=>'alipayqr_url',
        'std'=>'https://cdn.jsdelivr.net/gh/showrbq/kratos-alpha@'.KRATOS_VERSION.'/images/alipayqr.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'SEO配置',
        'type'=>'heading');
    ...
    $options[] = array(
        'name'=>'顶部图片',
        'id'=>'background_image',
        'std'=>'https://cdn.jsdelivr.net/gh/showrbq/kratos-alpha@'.KRATOS_VERSION.'/images/background.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'图片文字-1(可做文字标题)',
