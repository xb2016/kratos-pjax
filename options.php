...
function optionsframework_options(){
    ...
    $options[] = array(
        'name'=>'站点图标',
        'id'=>'site_ico',
        'std'=>'https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@'.KRATOS_VERSION.'/images/favicon.ico',
        'type'=>'upload');
    $options[] = array(
    ...
    $options[] = array(
        ...
        'std'=>'https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@'.KRATOS_VERSION.'/images/index_image.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'主页布局',
    ...
    $options[] = array(
        ...
        'id'=>'fa_url',
        'std'=>'https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@'.KRATOS_VERSION.'/css/font-awesome.min.css',
        'type'=>'text');
    $options[] = array(
        'name'=>'自定义Bootstrap(JS)',
        'desc'=>'自定义Bootstrap链接，留空将从本地加载',
        'id'=>'bs_url',
        'std'=>'https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@'.KRATOS_VERSION.'/js/bootstrap.min.js',
        'type'=>'text');
    $options[] = array(
        'name'=>'自定义jQuery',
        'desc'=>'自定义jQuery链接，留空将从本地加载',
        'id'=>'jq_url',
        'std'=>'https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@'.KRATOS_VERSION.'/js/jquery.min.js',
        'type'=>'text');
    $options[] = array(
        'name'=>'其它JS与CSS',
    ...
    $options[] = array(
        'name'=>'APlayer全局播放器',
        'desc'=>'启用页面左下角播放器(建议开启PJAX使用)',
        'id'=>'ap_footer',
        'std'=>'0',
        'type'=>'checkbox');
    $options[] = array(
        'name'=>'歌单JSON地址',
        'desc'=>'借助API可解析网易云歌单，如https://www.fczbl.vip/api/163/?type=playlist&id=2003373695',
        'id'=>'ap_json',
        'std'=>'https://www.fczbl.vip/api/163/?type=playlist&id=2003373695',
        'type'=>'text');
    $options[] = array(
        'name'=>'自动播放',
        'desc'=>'启用APlayer自动播放，个人不喜欢',
        'id'=>'ap_autoplay',
        'std'=>'0',
        'type'=>'checkbox');
    $options[] = array(
    ...
    $options[] = array(
        ...
        'id'=>'weixin_image',
        'std'=>'https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@'.KRATOS_VERSION.'/images/weixin.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'建站时间',
    ...
    $options[] = array(
        ...
        'id'=>'wechatpayqr_url',
        'std'=>'https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@'.KRATOS_VERSION.'/images/wechatpayqr.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'支付婊收款码',
        'desc'=>'上传你的支付婊收款二维码图片，图片尺寸要大于200px',
        'id'=>'alipayqr_url',
        'std'=>'https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@'.KRATOS_VERSION.'/images/alipayqr.png',
        'type'=>'upload');
    $options[] = array(
        'name'=>'SEO配置',
        'type'=>'heading');
    ...
    $options[] = array(
        'name'=>'顶部图片',
        'id'=>'background_image',
        'std'=>'https://cdn.jsdelivr.net/gh/xb2016/kratos-pjax@'.KRATOS_VERSION.'/images/background.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'图片文字-1(可做文字标题)',
