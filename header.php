...
<html>
  <head>
    ...
    <style><?php
        ...
        if(kratos_option('head_mode')=='pic') echo '@media(max-width:768px){#kratos-header-section{background:rgba('.hex2rgb(kratos_option('banner_color')).','.kratos_option('banner_color_op').')}}@media(min-width:768px){.color-logo{display:none}.affix{top:61px}}'; ?>
    </style>
  </head>
    <?php flush(); ?>
